...
pub const KeyDict_echo_opts = extern struct {
    err: Boolean = @import("std").mem.zeroes(Boolean),
...
pub const struct_object = extern struct {
    ...
    data: union_Data = @import("std").mem.zeroes(union_Data),
};
...
pub extern fn name_to_color(name: [*c]const u8, idx: [*c]c_int) c_int;
pub extern fn nvim_win_get_height(window: Window, err: [*c]Error) Integer;
pub extern fn nvim_win_get_cursor(window: Window, arena: [*c]Arena, err: [*c]Error) Array;
pub extern fn nvim_win_set_cursor(window: Window, pos: Array, err: [*c]Error) void;
pub extern fn nvim_buf_get_name(buffer: Buffer, err: [*c]Error) String;
pub extern fn nvim_buf_get_extmark_by_id(buffer: Buffer, ns_id: Integer, id: Integer, opts: [*c]KeyDict_get_extmark, arena: [*c]Arena, err: [*c]Error) Array;
...
pub extern fn nvim_notify(msg: String, log_level: Integer, opts: Dict, arena: [*c]Arena, err: [*c]Error) Object;
pub extern fn nvim_buf_get_lines(channel_id: u64, buffer: Buffer, start: Integer, end: Integer, strict_indexing: Boolean, arena: [*c]Arena, lstate: [*c]lua_State, err: [*c]Error) Array;
pub extern fn nvim_buf_set_lines(channel_id: u64, buffer: Buffer, start: Integer, end: Integer, strict_indexing: Boolean, replacement: Array, arena: [*c]Arena, err: [*c]Error) void;
pub extern fn nvim_buf_line_count(buffer: Buffer, err: [*c]Error) Integer;
pub extern fn get_global_lstate() [*c]?*anyopaque;
pub extern fn arena_alloc_block(arena: [*c]Arena) void;
...
pub const ArrayOf = @compileError("unable to translate C expr: expected ')' instead got '...'");
// api.c:91:9
