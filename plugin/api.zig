...
pub const DictEchoOpts = extern struct {
...
pub const struct_object = extern struct {
    ...
    data: union_unnamed_3 = @import("std").mem.zeroes(union_unnamed_3),
};
...
pub extern fn nvim_echo(chunks: Array, history: Boolean, opts: [*c]DictEchoOpts, err: [*c]Error) void;
